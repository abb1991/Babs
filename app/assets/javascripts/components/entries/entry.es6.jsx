  ...
  render() {
    return (
      ...
      {this.props.all_prompts.map((prompt, i) => {
        ...
        <br/>
        {this.props.data.user_id != this.props.data.viewer_id ?
          this.props.data.is_read ?
            <span className="mail-read"> &#9993; </span>
            : <span className="mail-unread"> &#9993; </span>
          : null}
        ...
        <span className="respond-button">
          <ReplyButton id={this.props.data.id} onShowBox={this.showBox}/>
        </span>
